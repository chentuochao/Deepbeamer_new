...
train_dataset, test_dataset = generate_data(if_TEST = 1, seg_length = 3, TRAIN_NUM = 5400, TEST_NUM= 600)
...
for (opt, sch, n) in opts:
    for i in range(n):
        ...
        losses, gains, inputgains=test_epoch(generative_model, loss_net, testloader)
